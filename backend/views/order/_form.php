...
//                                    'minimumInputLength' => 2,
                ...
                <td>
                    <?= $form->field($modelDetails, "[{$index}]unit_price")->textInput(['class' => ' form-control price'])->label(false) ?>
                </td>
                <td>
    ...
    <div class="form-group text-right">
        <?= Html::submitButton($modelDetails->isNewRecord ? 'Create' : '<i class="fa fa-save"> </i>   Update', ['class' => 'btn btn-primary']) ?>
