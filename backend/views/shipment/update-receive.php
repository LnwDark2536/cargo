    ...
    <div class="span12">
        <div class="grid simple horizontal green">
            <div class="grid-title">
                <h3 class="text-left"><i class="fa fa-file text-primary"></i> แก้ไข รายละเอียดการรับสินค้าแบบมีใบสั่งซื้อ (收货明细)</h3>
            </div>
            <div class="grid-body ">
                <div id="app-receive" v-cloak>
                    <div class="text-right" >
                        <button class="btn btn-success"  v-on:click="SaveDelivery()"><i class="fa fa-check"></i>
                            save update receipts
                        </button>
